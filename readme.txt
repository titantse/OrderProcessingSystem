...
The pons of this design is simple, and code logic is clear, but the cons it we added DB's burden, for the next phase, we could introduce cash to reduce the DB access.
